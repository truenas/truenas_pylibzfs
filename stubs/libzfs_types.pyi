...
class ZFSDOSFlag(enum.IntFlag):
    ...
    ZFS_OFFLINE = 17592186044416
    ZFS_READONLY = 4294967296
    ZFS_SPARSE = 35184372088832
...
@final
class ZFSSnapshot(ZFSResource):  # type: ignore[misc]
...
class ZFS:
    ...
    def create_resource(self, *, name: str, type: ZFSType, properties: dict[str, Any] | None = None, user_properties: dict[str, str] | None = None, crypto: Any | None = None) -> None: ...
    def create_pool(
        self,
        *,
        name: str,
    ...
    def resource_cryptography_config(self, *, keyformat: str | None = None, keylocation: str | None = None, pbkdf2iters: int | None = None, key: str | bytes | None = None, algorithm: str | None = None) -> Any: ...

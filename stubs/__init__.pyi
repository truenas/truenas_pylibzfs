...
class ZFS:
    ...
    def resource_cryptography_config(self, *, keyformat=None, keylocation=None, pbkdf2iters=1300000, key=None) -> None: ...
    def zpool_events(self, *, blocking=False, skip_existing_events=True): ...

...
"local_replicate(*, source, dest, fromsnap=None, send_flags=0, props=None, force=False, raw=False, pipe_size=1048576) -> None\n"
"---------------------------------------------------------------------------------------------------------------------------\n\n"
...
"the data between a background send and the calling-thread receive; both\n"
"sides run with the GIL released, so other Python threads continue to\n"
"make progress for the duration of the transfer.\n\n"
"Parameters\n"
"----------\n"
"source: str, required\n"
...
"    agree.\n"
"pipe_size: int, optional, default=1048576\n"
"    Requested size in bytes for the internal pipe buffer.  Larger\n"
"    values reduce context-switching between the send and receive\n"
"    sides on big transfers.  Best-effort: the kernel may cap the\n"
"    request (typically at /proc/sys/fs/pipe-max-size for non-root)\n"

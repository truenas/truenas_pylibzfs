...
"    \"module:property\" namespace, and userquota@ / groupquota@\n"
"    / projectquota@ entries.\n"
"    Per-property errors are NOT raised - an invalid entry\n"
"    (wrong value type, value out of range, etc.) is dropped\n"
"    silently while the receive itself still succeeds.  Use\n"
"    `zfs get` afterwards to confirm the values took effect.\n"

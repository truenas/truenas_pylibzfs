...
static const struct {
	...
	/* { ZFS_PROP_PREV_SNAP, "PREV_SNAP" }, -- hidden (zprop_register_hidden) */
	...
	/* { ZFS_PROP_PBKDF2_SALT, "PBKDF2_SALT" }, -- hidden (zprop_register_hidden) */
	{ ZFS_PROP_PBKDF2_ITERS, "PBKDF2_ITERS" },
	{ ZFS_PROP_ENCRYPTION_ROOT, "ENCRYPTION_ROOT" },
	/* { ZFS_PROP_KEY_GUID, "KEY_GUID" }, -- hidden (zprop_register_hidden) */
	{ ZFS_PROP_KEYSTATUS, "KEYSTATUS" },
	{ ZFS_PROP_SPECIAL_SMALL_BLOCKS, "SPECIAL_SMALL_BLOCKS" },
	/* { ZFS_PROP_REDACTED, "REDACTED" }, -- hidden (zprop_register_hidden) */
...
static const zpool_prop_t zpool_prop_table[] = {
	ZPOOL_PROP_INVAL,
	ZPOOL_PROP_NAME,
	ZPOOL_PROP_SIZE,
	ZPOOL_PROP_CAPACITY,

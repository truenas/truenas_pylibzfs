...
static const struct {
	...
	{ ZPOOL_PROP_AVAILABLE, "AVAILABLE" },
	{ ZPOOL_PROP_USABLE, "USABLE" },
	{ ZPOOL_PROP_USED, "USED" },
	{ ZPOOL_PROP_NORMAL_SIZE, "CLASS_NORMAL_SIZE" },
	{ ZPOOL_PROP_NORMAL_CAPACITY, "CLASS_NORMAL_CAPACITY" },
	{ ZPOOL_PROP_NORMAL_FREE, "CLASS_NORMAL_FREE" },
	{ ZPOOL_PROP_NORMAL_ALLOCATED, "CLASS_NORMAL_ALLOCATED" },
	{ ZPOOL_PROP_NORMAL_AVAILABLE, "CLASS_NORMAL_AVAILABLE" },
	{ ZPOOL_PROP_NORMAL_USABLE, "CLASS_NORMAL_USABLE" },
	{ ZPOOL_PROP_NORMAL_USED, "CLASS_NORMAL_USED" },
	{ ZPOOL_PROP_NORMAL_EXPANDSZ, "CLASS_NORMAL_EXPANDSIZE" },
	{ ZPOOL_PROP_NORMAL_FRAGMENTATION, "CLASS_NORMAL_FRAGMENTATION" },
	{ ZPOOL_PROP_SPECIAL_SIZE, "CLASS_SPECIAL_SIZE" },
	{ ZPOOL_PROP_SPECIAL_CAPACITY, "CLASS_SPECIAL_CAPACITY" },
	{ ZPOOL_PROP_SPECIAL_FREE, "CLASS_SPECIAL_FREE" },
	{ ZPOOL_PROP_SPECIAL_ALLOCATED, "CLASS_SPECIAL_ALLOCATED" },
	{ ZPOOL_PROP_SPECIAL_AVAILABLE, "CLASS_SPECIAL_AVAILABLE" },
	{ ZPOOL_PROP_SPECIAL_USABLE, "CLASS_SPECIAL_USABLE" },
	{ ZPOOL_PROP_SPECIAL_USED, "CLASS_SPECIAL_USED" },
	{ ZPOOL_PROP_SPECIAL_EXPANDSZ, "CLASS_SPECIAL_EXPANDSIZE" },
	{ ZPOOL_PROP_SPECIAL_FRAGMENTATION, "CLASS_SPECIAL_FRAGMENTATION" },
	{ ZPOOL_PROP_DEDUP_SIZE, "CLASS_DEDUP_SIZE" },
	{ ZPOOL_PROP_DEDUP_CAPACITY, "CLASS_DEDUP_CAPACITY" },
	{ ZPOOL_PROP_DEDUP_FREE, "CLASS_DEDUP_FREE" },
	{ ZPOOL_PROP_DEDUP_ALLOCATED, "CLASS_DEDUP_ALLOCATED" },
	{ ZPOOL_PROP_DEDUP_AVAILABLE, "CLASS_DEDUP_AVAILABLE" },
	{ ZPOOL_PROP_DEDUP_USABLE, "CLASS_DEDUP_USABLE" },
	{ ZPOOL_PROP_DEDUP_USED, "CLASS_DEDUP_USED" },
	{ ZPOOL_PROP_DEDUP_EXPANDSZ, "CLASS_DEDUP_EXPANDSIZE" },
	{ ZPOOL_PROP_DEDUP_FRAGMENTATION, "CLASS_DEDUP_FRAGMENTATION" },
	{ ZPOOL_PROP_LOG_SIZE, "CLASS_LOG_SIZE" },
	{ ZPOOL_PROP_LOG_CAPACITY, "CLASS_LOG_CAPACITY" },
	{ ZPOOL_PROP_LOG_FREE, "CLASS_LOG_FREE" },
	{ ZPOOL_PROP_LOG_ALLOCATED, "CLASS_LOG_ALLOCATED" },
	{ ZPOOL_PROP_LOG_AVAILABLE, "CLASS_LOG_AVAILABLE" },
	{ ZPOOL_PROP_LOG_USABLE, "CLASS_LOG_USABLE" },
	{ ZPOOL_PROP_LOG_USED, "CLASS_LOG_USED" },
	{ ZPOOL_PROP_LOG_EXPANDSZ, "CLASS_LOG_EXPANDSIZE" },
	{ ZPOOL_PROP_LOG_FRAGMENTATION, "CLASS_LOG_FRAGMENTATION" },
	{ ZPOOL_PROP_ELOG_SIZE, "CLASS_ELOG_SIZE" },
	{ ZPOOL_PROP_ELOG_CAPACITY, "CLASS_ELOG_CAPACITY" },
	{ ZPOOL_PROP_ELOG_FREE, "CLASS_ELOG_FREE" },
	{ ZPOOL_PROP_ELOG_ALLOCATED, "CLASS_ELOG_ALLOCATED" },
	{ ZPOOL_PROP_ELOG_AVAILABLE, "CLASS_ELOG_AVAILABLE" },
	{ ZPOOL_PROP_ELOG_USABLE, "CLASS_ELOG_USABLE" },
	{ ZPOOL_PROP_ELOG_USED, "CLASS_ELOG_USED" },
	{ ZPOOL_PROP_ELOG_EXPANDSZ, "CLASS_ELOG_EXPANDSIZE" },
	{ ZPOOL_PROP_ELOG_FRAGMENTATION, "CLASS_ELOG_FRAGMENTATION" },
	{ ZPOOL_PROP_SELOG_SIZE, "CLASS_SPECIAL_ELOG_SIZE" },
	{ ZPOOL_PROP_SELOG_CAPACITY, "CLASS_SPECIAL_ELOG_CAPACITY" },
	{ ZPOOL_PROP_SELOG_FREE, "CLASS_SPECIAL_ELOG_FREE" },
	{ ZPOOL_PROP_SELOG_ALLOCATED, "CLASS_SPECIAL_ELOG_ALLOCATED" },
	{ ZPOOL_PROP_SELOG_AVAILABLE, "CLASS_SPECIAL_ELOG_AVAILABLE" },
	{ ZPOOL_PROP_SELOG_USABLE, "CLASS_SPECIAL_ELOG_USABLE" },
	{ ZPOOL_PROP_SELOG_USED, "CLASS_SPECIAL_ELOG_USED" },
	{ ZPOOL_PROP_SELOG_EXPANDSZ, "CLASS_SPECIAL_ELOG_EXPANDSIZE" },
	{ ZPOOL_PROP_SELOG_FRAGMENTATION, "CLASS_SPECIAL_ELOG_FRAGMENTATION" },
};
_Static_assert(ZPOOL_NUM_PROPS -1 == ZPOOL_PROP_SELOG_FRAGMENTATION);
